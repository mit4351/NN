...
def backward(x, z1, z2, y, m2, t, W1, W2, W3):
    ...
    #print("y.shape=%s :: t.shape=%s :: y=%s :: t=%s" % (y.shape, t.shape, y, t))
    #print("dC_da3.shape=%s" % (dC_da3.shape))
    #print("**** y.shape=%s y=%s" % (y.shape, y))
    #print("==== t.shape=%s t=%s" % (t.shape, t))
    #print("dC_da3.shape=%s  =%s" % (dC_da3.shape, dC_da3))
    #print("dC_da3=%s" % (dC_da3))
    dC_dW3 = np.dot(z2.T, dC_da3)
    #print("z2.T.shape=%s :: dC_da3.shape=%s :: dC_dW3.shape=%s" % (z2.T.shape, dC_da3.shape,dC_dW3.shape))
    #print("z2.shape=%s :: z2.T.shape=%s :: dC_dW3.shape=%s" % (z2.shape, z2.T.shape, dC_dW3.shape))
...
if  __name__ == '__main__':
    ...
    output_filename = "mit_nn3tanh.pkl"
